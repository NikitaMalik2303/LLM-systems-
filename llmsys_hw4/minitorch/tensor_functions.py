...
class Attn_Softmax(Function):
    ...
    def backward(ctx: Context, out_grad: Tensor) -> Tensor:
      #   BEGIN ASSIGN4_1_2
      soft_out= ctx.saved_values[0]
      grad_inp= out_grad.backend.attn_softmax_bw(out_grad, soft_out)
...
class LayerNorm(Function):
    ...
    def backward(ctx: Context, out_grad: Tensor) -> Tensor:
      #   BEGIN ASSIGN4_2_2
        ...
        inp_grad, gamma_grad, beta_grad = inp.backend.layernorm_bw(out_grad, inp, gamma, beta, var, mean)
