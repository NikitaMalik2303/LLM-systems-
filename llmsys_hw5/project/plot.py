...
if __name__ == '__main__':
    ...
    single_mean, single_std = 14.75021288394928, 0.1858771210599166  # Single GPU training time
    device0_mean, device0_std = 8.254879975318909, 0.3150085555727911  # GPU0 training time with 2 GPUs
    device1_mean, device1_std = 7.562963128089905, 0.26315579556112256  # GPU1 training time with 2 GPUs
